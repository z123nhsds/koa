...
module.exports = {
  ...
  /**
   * When enabled, `response.type` will only set the Content-Type
   * header if it has not already been set. This prevents middleware
   * from overwriting a previously set Content-Type.
   *
   * @type {Boolean}
   * @api public
   */
